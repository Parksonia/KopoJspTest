...
<body>
    <h2>1. 로그인 폼</h2>
    <% 
    String loginErr = request.getParameter("loginErr");   //로그인 실패의 경우 loginErr 밸류값인 1을 받아옴
    if (loginErr != null) out.print("로그인 실패");  // 로그인 실패시 출력 
    %>
    ...
    <form action="./ResponseHeader.jsp" method="get"> <!--  form으로 묶여있다해서 post만 되는거 아니고 get도 가능하나 value값이 url에 보이게 됨 -->
