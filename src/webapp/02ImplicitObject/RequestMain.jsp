...
<body>
    ...
    <form method="post" action="RequestParameter.jsp">  <!--다양한 <input> 태그 사용-->
        ...
        성별 :
        <input type="radio" name="sex" value="man" />남자  <!-- radio(중복안됨) 선택은 하나만 선택하게 되어 있기때문에 name같아도 됨 -->
        <input type="radio" name="sex" value="woman" checked="checked" />여자
        <br />
        관심사항 :
        <input type="checkbox" name="favo" value="eco" />경제
        <input type="checkbox" name="favo" value="pol" checked="checked" />정치
        <input type="checkbox" name="favo" value="ent" />연예<br />  <!--check box 중복선택 가능 -->
        자기소개:
        <textarea name="intro" cols="30" rows="4"></textarea>
        <br />
        <input type="submit" value="전송하기" /> <!--데이터를 전송해주는 button이 됨 -->
    </form>
