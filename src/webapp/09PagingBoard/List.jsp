...
Map<String,Object> param =new HashMap<String,Object>();  //입력-> 저장
...
param.put("start", start); //맵으로 보내기
param.put("end",end);

/* 페이지 처리 끝 */

List<BoardDTO> boardLists = dao.selectListPage(param);  //게시물 받아오기
dao.close(); // db 연결 닫기 
...
<body>
	...
	<h2>목록 보기- 현재페이지=<%=pageNum%>/<%=totalPage%></h2>
	<!-- 검색폼 -->
	<form method="get">
